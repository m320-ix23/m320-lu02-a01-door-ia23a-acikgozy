...
class Door:
    """
    Diese Class beschreibt eine Türe mit der Eigenschaft color (Farbe) und den Zuständen
    ...
    # Der Konstruktor trägt IMMER den Namen __init__ und weist als ersten Parameter den Wert auf.
